...
time_arr = []
for el in range(3, 31):
    t_1 = datetime(2023, 11, el, 8, 10)
    time_arr.append(t_1)
    t_2 = datetime(2023, 11, el, 12, 10)
    time_arr.append(t_2)
    t_3 = datetime(2023, 11, el, 16, 10)
    time_arr.append(t_3)
    t_4 = datetime(2023, 11, el, 20, 10)
    time_arr.append(t_4)
...
for el in time_arr:
    ...
    if random_elem_name is None:
        ...
        if caption and image:
            ...
            with app:
                app.send_photo(chat_id="@doctor_psyh", photo=image, caption=caption, schedule_date=el)
